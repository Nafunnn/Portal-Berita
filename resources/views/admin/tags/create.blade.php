<x-layouts.admin>
    <h1 class="mb-6 font-display text-3xl text-ink">Tambah Tag</h1>
    <form action="{{ route('admin.tags.store') }}" method="POST" class="max-w-lg rounded-card border border-hairline bg-white p-6">
        @csrf
        <div class="mb-4">
